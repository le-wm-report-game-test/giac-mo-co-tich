...
func test_camera_clipping_keeps_tree_visible_when_near() -> void:
	...
	assert_true(test_tree.visible, "Tree should stay visible when camera is near; no hard camera clipping")
