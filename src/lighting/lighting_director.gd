...
func _apply_quality_settings() -> void:
	...
	_sun.shadow_blur = 1.35 if cinematic else 1.0
	_sun.shadow_opacity = 0.82 if cinematic else 0.76
	...
	_environment.ssao_radius = 1.6 if cinematic else 1.25
	_environment.ssao_intensity = 0.85 if cinematic else 0.65
	_environment.ssao_power = 1.1
	_environment.ssao_detail = 0.45 if cinematic else 0.25
	_environment.ssil_enabled = cinematic
	_environment.ssil_radius = 2.4
	_environment.ssil_intensity = 0.65
