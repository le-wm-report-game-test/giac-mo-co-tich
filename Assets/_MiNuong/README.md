# Mi Nuong (Mỵ Nương) — Sprite Asset Mapping Guide

This directory contains segmented, transparent 2.5D top-down sprite assets for the character **Mỵ Nương (Mi Nuong)**.
...
├── attack/                 # Melee attack animations (2 frames per direction)
...
*   **Description:** Breathing loop while standing still.
...
*   **Description:** Melee combat action (empty-handed strike).
*   **Frame Count:** 2 frames per direction.
